...
// const SubCategoryTypography = styled(Typography)(({ theme }) => ({
//   fontFamily: '"Montserrat", sans-serif',
//   fontWeight: 600,
//   color: '#4B4B4B',
//   fontSize: '1rem',
...
//                         (() => {
//                           const categories = {};
//                           (order.items && Array.isArray(order.items) ? order.items : []).forEach(item => {
//                             const { categoryName, name, type, quantity, veg, subCategoryName } = item || {};
...
//                               <BodyTypography variant="h6" sx={{ p: 2, fontWeight: 600 }}>
//                                 {categoryName}
//                               </BodyTypography>
...
//                                     <ListItem key={`${item.itemId}-${item.type}-${index}`} sx={{ pl: categoryName === 'Khana Khazana' && subCategoryName !== 'Items' ? 4 : 2 }}>
//                                       <ListItemText
//                                         primary={`${item.displayName} (${item.type || 'Unknown'})`}
//                                         secondary={
//                                           <>
//                                             {item.type === 'dish' && (
//                                               <>
...
//       const sortedOrders = (orderData || []).sort((a, b) => new Date(b.functionDate) - new Date(a.functionDate));
